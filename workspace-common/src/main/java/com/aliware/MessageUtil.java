...
public class MessageUtil {
    ...
    public static Server decode(String content) {
        ...
        long throughput = PaddingUtil.getLongFromPadded(content, TypeUtil.BYTE_MAX_LENGTH, TypeUtil.LONG_MAX_LENGTH);
        long time = PaddingUtil.getLongFromPadded(content, TypeUtil.BYTE_MAX_LENGTH + TypeUtil.LONG_MAX_LENGTH, TypeUtil.LONG_MAX_LENGTH);
        return new Server()
